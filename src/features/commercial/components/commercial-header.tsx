...
export function CommercialHeader({ onOpenMobile, onToggleSidebar, sidebarOpen, title }: CommercialHeaderProps) {
  return (
      ...
      <div className="flex h-16 items-center gap-4 px-4 md:px-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="hidden text-sm text-muted-foreground md:block">Suivi commercial, clients et preparation des ventes.</p>
          </div>
        </div>
