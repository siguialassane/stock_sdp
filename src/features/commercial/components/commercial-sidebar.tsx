import { BriefcaseBusiness, ChevronLeft, ChevronRight, LogOut, User } from "lucide-react";
        ...
        <div className="flex h-16 items-center gap-3 border-b px-4">
          ...
          {sidebarOpen ? (
            <div>
              ...
              <div className="text-xs text-muted-foreground">Espace Commercial</div>
            </div>
          ) : null}
        </div>
          ...
          <div className="flex items-center gap-3 rounded-lg px-2 py-2">
            ...
            {sidebarOpen ? (
              <div className="min-w-0 flex-1">
                <p className="truncate text-sm font-medium">{session?.displayName ?? "Commercial"}</p>
