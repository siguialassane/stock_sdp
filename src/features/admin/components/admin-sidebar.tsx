import { ChevronLeft, ChevronRight, LogOut, ShieldCheck, User } from "lucide-react";
...
/**
 * Barre laterale de l'ecran Admin.
 * Meme structure visuelle que la sidebar du dashboard (sticky h-screen, bloc
 * user + deconnexion fixe en bas), mais avec un menu specifique Admin et une
 * navigation TanStack Router qui reflete la route active.
 */
      ...
      <div className="flex h-16 items-center gap-3 border-b px-4">
        ...
        {sidebarOpen && (
          <div>
            ...
            <div className="text-xs text-muted-foreground">Espace Admin</div>
          </div>
        )}
      </div>
        ...
        <div className="flex items-center gap-3 rounded-lg px-2 py-2">
          ...
          {sidebarOpen && (
            <div className="min-w-0 flex-1">
              <p className="truncate text-sm font-medium">{session?.displayName ?? "Administrateur"}</p>
